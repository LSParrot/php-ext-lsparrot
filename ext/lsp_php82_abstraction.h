...
static inline const char *lsp_php82_ast_kind_name(zend_ast_kind kind)
{
	switch (kind) {
...
static inline bool lsp_php82_ast_is_decl(zend_ast *ast)
{
	return zend_ast_is_special(ast) && ast->kind >= ZEND_AST_FUNC_DECL;
}

static inline bool lsp_php82_ast_is_opaque_node(zend_ast_kind kind)
{
