--TEST--
LSP keeps lsparrot PHPDoc template member completions available with Psalm LS only
--EXTENSIONS--
lsparrot
--STDIN--
Content-Length: 128

{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"rootUri":"file:///tmp/lsp-psalm-ls-lsparrot-template-completion-test"}}Content-Length: 668

{"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"uri":"file:///tmp/lsp-psalm-ls-lsparrot-template-completion-test/src/Demo.php","languageId":"php","version":1,"text":"<?php\n\nnamespace PsalmLsLSParrotTemplateFixture;\n\nuse PsalmLsLSParrotTemplateFixture\\Domain\\User;\n\nfinal class Demo\n{\n    /**\n     * @psalm-template T\n     * @psalm-param T $value\n     * @psalm-return T\n     */\n    public function templateTestPsalm(mixed $value): mixed\n    {\n        return $value;\n    }\n\n    public function run(): void\n    {\n        $user = new User();\n        $val = $this->templateTestPsalm($user);\n        $val->fo\n    }\n}"}}}Content-Length: 205

{"jsonrpc":"2.0","id":2,"method":"textDocument/completion","params":{"textDocument":{"uri":"file:///tmp/lsp-psalm-ls-lsparrot-template-completion-test/src/Demo.php"},"position":{"line":22,"character":16}}}Content-Length: 56

{"jsonrpc":"2.0","id":3,"method":"shutdown","params":[]}
--FILE--
<?php
$root = '/tmp/lsp-psalm-ls-lsparrot-template-completion-test';
