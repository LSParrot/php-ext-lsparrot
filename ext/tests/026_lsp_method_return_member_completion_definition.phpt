--TEST--
LSP completes and resolves definitions for variables assigned from same-class method return types
--EXTENSIONS--
lsparrot
--STDIN--
Content-Length: 104

{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"rootUri":"file:///tmp/lsp-return-member-test"}}Content-Length: 536

{"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"uri":"file:///tmp/lsp-return-member-test/src/Service/UserRepository.php","languageId":"php","version":1,"text":"<?php\n\nnamespace ReturnFixture\\Service;\n\nuse ReturnFixture\\Domain\\Collection;\n\nfinal class UserRepository\n{\n    public function findActiveUsers(): Collection\n    {\n        return new Collection();\n    }\n\n    public function acceptPayload(): void\n    {\n        $val = $this->findActiveUsers();\n        $val->all();\n    }\n}\n"}}}Content-Length: 199

{"jsonrpc":"2.0","id":2,"method":"textDocument/completion","params":{"textDocument":{"uri":"file:///tmp/lsp-return-member-test/src/Service/UserRepository.php"},"position":{"line":16,"character":14}}}Content-Length: 199

{"jsonrpc":"2.0","id":3,"method":"textDocument/definition","params":{"textDocument":{"uri":"file:///tmp/lsp-return-member-test/src/Service/UserRepository.php"},"position":{"line":16,"character":15}}}Content-Length: 56

{"jsonrpc":"2.0","id":4,"method":"shutdown","params":[]}
--FILE--
<?php
$root = '/tmp/lsp-return-member-test';
@mkdir($root . '/src/Domain', 0777, true);
@mkdir($root . '/src/Service', 0777, true);
@mkdir($root . '/vendor/bin', 0777, true);
@mkdir($root . '/vendor/composer', 0777, true);
file_put_contents($root . '/src/Domain/Collection.php', "<?php\nnamespace ReturnFixture\\Domain;\nfinal class Collection\n{\n    public function all(): array\n    {\n        return [];\n    }\n}\n");
file_put_contents($root . '/src/Service/UserRepository.php', "<?php\nnamespace ReturnFixture\\Service;\nuse ReturnFixture\\Domain\\Collection;\nfinal class UserRepository\n{\n    public function findActiveUsers(): Collection\n    {\n        return new Collection();\n    }\n}\n");
file_put_contents($root . '/vendor/composer/autoload_classmap.php', "<?php\nreturn [\n    'ReturnFixture\\\\Domain\\\\Collection' => " . var_export($root . '/src/Domain/Collection.php', true) . ",\n    'ReturnFixture\\\\Service\\\\UserRepository' => " . var_export($root . '/src/Service/UserRepository.php', true) . ",\n];\n");
...
%A"jsonrpc":"2.0","id":3,"result"%A"uri":"file:///tmp/lsp-return-member-test/src/Domain/Collection.php"%A"line":4%AContent-Length: %d
