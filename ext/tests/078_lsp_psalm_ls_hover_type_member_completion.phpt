--TEST--
LSP completes Psalm Language Server hover-inferred receiver members
--EXTENSIONS--
lsparrot
--STDIN--
Content-Length: 116

{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"rootUri":"file:///tmp/lsp-psalm-ls-hover-completion-test"}}Content-Length: 662

{"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"uri":"file:///tmp/lsp-psalm-ls-hover-completion-test/src/Demo.php","languageId":"php","version":1,"text":"<?php\n\nnamespace PsalmLsHoverCompletionFixture;\n\nuse PsalmLsHoverCompletionFixture\\Domain\\User;\n\nfinal class Demo\n{\n    /**\n     * @psalm-template T\n     * @psalm-param T $value\n     * @psalm-return T\n     */\n    public function templateTestPsalm(mixed $value): mixed\n    {\n        return $value;\n    }\n\n    public function run(): void\n    {\n        $user1 = new User();\n        $val2 = $this->templateTestPsalm($user1);\n        $val2->actual\n    }\n}"}}}Content-Length: 193

{"jsonrpc":"2.0","id":2,"method":"textDocument/completion","params":{"textDocument":{"uri":"file:///tmp/lsp-psalm-ls-hover-completion-test/src/Demo.php"},"position":{"line":22,"character":21}}}Content-Length: 56

{"jsonrpc":"2.0","id":3,"method":"shutdown","params":[]}
--FILE--
<?php
$root = '/tmp/lsp-psalm-ls-hover-completion-test';
@mkdir($root . '/src/Domain', 0777, true);
@mkdir($root . '/vendor/bin', 0777, true);
@mkdir($root . '/vendor/composer', 0777, true);
file_put_contents($root . '/composer.json', "{\"autoload\":{\"psr-4\":{\"PsalmLsHoverCompletionFixture\\\\\\\\\":\"src/\"}}}\n");
...
<?php
namespace PsalmLsHoverCompletionFixture\Domain;
final class User
{
...
PHP);
file_put_contents($root . '/vendor/composer/autoload_classmap.php', "<?php\nreturn [\n    'PsalmLsHoverCompletionFixture\\\\Domain\\\\User' => " . var_export($root . '/src/Domain/User.php', true) . ",\n    'PsalmLsHoverCompletionFixture\\\\Demo' => " . var_export($root . '/src/Demo.php', true) . ",\n];\n");
    ...
    if ($method === 'textDocument/hover') {
        frame_write([
            ...
            'result' => [
                'contents' => [
                    'kind' => 'markdown',
                    'value' => "```php\n<?php declare(strict_types=1);\nPsalmLsHoverCompletionFixture\\Domain\\User\n```",
                ],
            ],
        ]);
        continue;
...
?>
--EXPECTREGEX--
[\s\S]*"jsonrpc":"2\.0","id":2,"result"[\s\S]*"label":"actualUserMethod"[\s\S]*"source":"psalm-ls"[\s\S]*\{"jsonrpc":"2\.0","id":3,"result":null\}
